...
if (isset($_POST['signup'])) {
    ...
    if (!isset($error)) {
        ...
        $result = mysqli_query($dbc, "INSERT INTO owners (name, email, password, phone_number, address) 
...
<body>
    <div class="container mt-5">
        ...
        <?php else: ?>
            <h2 class="mb-4 text-center">Owner Sign-up</h2>
            <form method="post" class="row g-3">
                ...
                <!-- Login Link -->
                <div class="col-12">
                    <p>Have an Account? <a href="owner_login.php">Owner_Login</a></p>
                </div>
            </form>
        <?php endif; ?>
    </div>
